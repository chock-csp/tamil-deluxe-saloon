...
import { Lock, LogOut, Radio, Save, CheckCircle2, Eye, KeyRound, AlertCircle, ArrowLeft, RefreshCw } from 'lucide-react';
...
export default function AdminPage() {
        ...
        <div className="w-full max-w-md glass-panel rounded-3xl p-6 sm:p-8 border border-amber-500/30 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-amber-300/70">
              Sign in to manage the 10 paired YouTube & Spotify playlists
            </p>
          </div>
  ...
  // 2. AUTHENTICATED: Render 10-Row Playlist Manager
  return (
        ...
        <div className="glass-panel rounded-3xl p-5 border border-amber-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-black text-amber-200">
                10-Row Playlist Manager
              </h1>
              <p className="text-xs text-amber-300/70">
                Row 1 to Row 10 Paired YouTube & Spotify Playlists
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span>View Minimal Main Site</span>
            </Link>
            ...
            >
              ...
              <span>{saving ? 'Saving...' : 'Save All 10 Rows'}</span>
            </button>
        ...
        <div className="glass-panel p-4 sm:p-6 rounded-3xl border border-amber-500/25 space-y-4">
          <div className="flex items-center justify-between border-b border-amber-500/20 pb-3">
            <h2 className="text-base font-bold text-amber-200">
              Configure 10 Paired Playlist Rows
            </h2>
            <p className="text-xs text-amber-300/60">
              Active radio selects index <code className="text-amber-300">(Day % 10)</code> or your selected row below.
            </p>
          </div>

          <div className="space-y-4">
            {rows.slice(0, 10).map((row, idx) => {
              const isSelected = activeOverrideId === row.id;
              ...
              return (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center space-x-3">
                      <span className="px-3 py-1 rounded-lg bg-amber-500/20 border border-amber-500/30 text-amber-300 font-mono font-bold text-xs">
                        Row {idx + 1}
                      </span>
                      <input
                        type="text"
                    ...
                    {/* Active Radio Select Button */}
                    <button
                      onClick={() => setActiveOverrideId(isSelected ? null : row.id)}
                    ...
                    >
                      {isSelected ? '✓ Active Radio Row' : 'Set Active'}
                    </button>
                  </div>
          ...
          <div className="pt-4 flex justify-end">
            ...
            >
              {saving ? 'Saving All 10 Rows...' : 'Save All 10 Rows'}
            </button>
          </div>
